# Unofficial Snap Packaging for Bashfuscator
This is the unofficial snap packaging for Bashfuscator, [Snaps are universal Linux packages](https://snapcraft.io).

Refer [snap/README.md](snap/README.md) for user-oriented information.

## Remaining Tasks
Snapcrafters ([join us](https://forum.snapcraft.io/t/join-snapcrafters/1325)) are working to land snap install documentation and the [snapcraft.yaml](https://github.com/Lin-Buo-Ren/snapcrafters-template-plus/blob/master/snap/snapcraft.yaml) upstream so Bashfuscator can authoritatively publish future releases.
...
- [x] Update logos and references to `Bashfuscator`, `bashfuscator` and other placeholder names in `README.md`, `snap/README.md`, and `snap/snapcraft.yaml`
...
| Packager | Upstream |
| :-: | :-: |
| [![Packager's avatar](http://gravatar.com/avatar/66a5b84972e73e895d5d68d48b1e1e21/?s=128)<br>林博仁(Buo-ren, Lin)](mailto:Buo.Ren.Lin@gmail.com) | [Project issue tracker](https://github.com/Bashfuscator/Bashfuscator/issues) |
